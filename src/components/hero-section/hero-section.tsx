      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 min-h-[20rem] md:h-[36rem] items-center">
        <div className="flex flex-col items-center justify-center gap-4 md:items-start lg:items-start">
          ...
          <div className="flex flex-col items-center justify-center gap-4 md:items-start lg:items-start">
            ...
            <div className="text-white glex flex-col gap-2 mt-5 items-center md:items-start lg:items-start">
        ...
        <div
          className="relative h-[20rem] hidden md:h-full order-first md:order-last items-center 
        justify-center md:flex lg:flex"
        >
          <Image
            src="/hero-section.svg"
            alt="ilustração com icones de store"
            width={200}
            height={400}
